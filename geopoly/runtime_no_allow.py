...
APP_NAME = 'GeoPoly'
VERSION = '27.2h'
EDITION = 'Runtime Allow-list Audit'
...
def version_info():
    return {
        ...
        'version': VERSION,
        'edition': EDITION,
        'implementation': 'split internal modules with explicit public imports; broad runtime re-merge removed; net-certification, nesting/tiling and batch-optimizer stacks consolidated; class-native behavior preserved; internal wildcard imports removed; runtime compatibility allow-list audited and reduced to the required self-test bindings; public smoke-test aliases preserved',
